...
if ($_POST) {
	$cadAlimento = new Alimentos();
	$cadAlimento->cadastrarAlimento($_POST['descricao_alimento'], $_POST['marca_alimento'], $_POST['qntd_carboidratos'], $_POST['qntd_proteinas'], $_POST['qntd_gorduras'], $_POST['tamanho_porcao'], $_POST['unidade_medida']);

	header('Location: ?p=novo_alimento');
}
?>
<div class="container">
	<div class="row">
